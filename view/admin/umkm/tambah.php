...
<form action="<?= BASE_URL ?>/aksi/tambah-umkm" method="POST" enctype="multipart/form-data">
  <div class="row mb-3">
    <div class="col-md-6"><label class="form-label fw-500">Nama UMKM <span class="text-danger">*</span></label>
      <input type="text" name="nama_umkm" class="form-control" required /></div>
    <div class="col-md-6"><label class="form-label fw-500">Pemilik</label>
      <input type="text" name="pemilik" class="form-control" /></div>
  </div>
  <div class="row mb-3">
    <div class="col-md-6"><label class="form-label fw-500">Kategori</label>
      <select name="kategori" class="form-select">
        <option value="kuliner">Kuliner</option><option value="kerajinan">Kerajinan</option>
        <option value="souvenir">Souvenir</option><option value="jasa">Jasa</option><option value="lainnya">Lainnya</option>
      </select></div>
    <div class="col-md-6"><label class="form-label fw-500">Kontak</label>
      <input type="text" name="kontak" class="form-control" placeholder="No. HP / WhatsApp" /></div>
  </div>
  <div class="mb-3"><label class="form-label fw-500">Produk Unggulan</label>
    <input type="text" name="produk_unggulan" class="form-control" /></div>
  ...
  <div class="mb-4"><label class="form-label fw-500">Foto UMKM</label>
